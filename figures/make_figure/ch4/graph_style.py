...
def get_margin():
    """Get the margin size in terms of figure width."""
    margin = 0.01
    return margin * get_fig_width()
...
def place_letter(fig, letter, x=0.01, y=1.0):
    """Place a letter in the top left corner of the figure."""
    fig.text(x, y, letter, fontsize=12, fontweight="bold", va="top", ha="left")
