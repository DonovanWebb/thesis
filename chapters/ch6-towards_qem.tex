...
\subsection{Theory}
    ...
    - We can generally do this via Hadamard test (generalise to U in figure) for phase kickback on spin \\
    - For full state tomography, we can measure characteristic function~\cite{}\todo{cite Fluhman, OB, SS thesis}.\\
    - Give circuit for tomography using SDFs. \\
...
\subsubsection{Two Spin Dependent Forces}
    - Experimental sequence, state prep, doppler, SBC, ramped 4 tones, SDF.\\
