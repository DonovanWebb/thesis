...
Finally, we note that if we cannot assume nada, then we need custom models, out of scope, non-markovian.
...
1) Twirling / symmetry reduction. RB-derived methods simplify the channel through randomisation or twirling. 

Restricted noise models. Harper, ACES and the graphical-model work assume/exploit Pauli or otherwise structured error models. These approaches obtain scalability by restricting the space of possible correlated errors.

Locality and conditional structure. Sarovar, Gulácsi and perhaps Harper 2023 fit here: exploit locality, conditional independence or known physical structure to infer correlations without reconstructing the complete global channel.

General models with greater cost.
GST
...
\subsection{Irreps and sector decomposition}
