...
% Pre reqs:
    ...
    \begin{figure}
        ...
        \caption{
            ...
            Figures b) and d) adapted from Ref.~\cite{choonee2017silicon}, other panels adapted from private communication with the \emph{NPL} team.
        \label{fig:trap}}
    \end{figure}
    ...
    the manufacturing of complex multi-zone devices with many DC electrodes, amenable to ion shuttling~\cite{}, and hence furthering progress towards Quantum CCD
    ...
    trapping potential is often greatly reduced due to anharmonicity~\cite{}, and the close proximity of the
    surface to the ion can be a large contributor to motional heating
    rates~\cite{wineland1998experimental, turchette2000heating, haeffner}. \\
    ...
    Details on its design and characterisations can be found in Ref.~\cite{see2013fabrication,
    ...
    the intermediate substrate~\cite{wilpers2013compact}. The trap chip 
...
% Figures
    ...
    of the \emph{Artiq Sinara}~\cite{kasprowicz2020artiq} hardware ecosystem. \emph{Urukul} is used extensively in our lab for driving acousto-optic modulators (AOMs) and here used as the source drive of our trap RF.
    ...
    figure~\ref{fig:res_H} (a). The inductor consists of XX(\todo{ToDo gauge and oxygen?})
    ...
    lower sidebands ($-\Delta f$), as shown in panel $(b)$, following reference~\cite{danielsonAM2018}. We
