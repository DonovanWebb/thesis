...
\begin{enumerate}
    ...
    \begin{itemize}
        \item Intro for why we built a new apparatus. What we wanted to achieve with it. 
        ...
        \item Section on Pulse shaping with phaser, sinara? Link this to requirements/theory for frequency selectivity.
