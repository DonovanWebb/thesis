...
\todo{Define propagator as $R_{x}$ to match QEM chapter}\\

\subsection{Coupling to Motion}
\label{sec:Motional Coupling}
\todo{Expand in Lamb-Dicke limit to get Jaynes Cummings}

% Sidebands
% SDFs
\subsubsection{Spin-Dependent Force}
\label{sec:SDF}
